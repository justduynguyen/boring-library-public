...
namespace BoringLibrary.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Credit = table.Column<double>(type: "double precision", nullable: false, defaultValue: 100.0),
                    ExtraProperties = table.Column<string>(type: "text", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppBookBorrowers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppBookBorrowers_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppBookBorrowers_AppBooks_BookId",
                        column: x => x.BookId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppBookBorrowers_BookId",
                table: "AppBookBorrowers",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_AppBookBorrowers_UserId",
                table: "AppBookBorrowers",
                column: "UserId");
